...
import APERY = require( './../../../float64/apery' );
import CATALAN = require( './../../../float64/catalan' );
import CBRT_EPS = require( './../../../float64/cbrt-eps' );
import E = require( './../../../float64/e' );
import EPS = require( './../../../float64/eps' );
import EULERGAMMA = require( './../../../float64/eulergamma' );
import EXPONENT_BIAS = require( './../../../float64/exponent-bias' );
import FOURTH_PI = require( './../../../float64/fourth-pi' );
import FOURTH_ROOT_EPS = require( './../../../float64/fourth-root-eps' );
import GAMMA_LANCZOS_G = require( './../../../float64/gamma-lanczos-g' );
import GLAISHER = require( './../../../float64/glaisher-kinkelin' );
import HALF_LN2 = require( './../../../float64/half-ln-two' );
import HALF_PI = require( './../../../float64/half-pi' );
import HIGH_WORD_ABS_MASK = require( './../../../float64/high-word-abs-mask' );
import HIGH_WORD_EXPONENT_MASK = require( './../../../float64/high-word-exponent-mask' );
import HIGH_WORD_SIGN_MASK = require( './../../../float64/high-word-sign-mask' );
import HIGH_WORD_SIGNIFICAND_MASK = require( './../../../float64/high-word-significand-mask' );
import LN_HALF = require( './../../../float64/ln-half' );
import LN_PI = require( './../../../float64/ln-pi' );
import LN_SQRT_TWO_PI = require( './../../../float64/ln-sqrt-two-pi' );
import LN10 = require( './../../../float64/ln-ten' );
import LN2 = require( './../../../float64/ln-two' );
import LN_TWO_PI = require( './../../../float64/ln-two-pi' );
import LOG2E = require( './../../../float64/log2-e' );
import LOG10E = require( './../../../float64/log10-e' );
import MAX = require( './../../../float64/max' );
import MAX_BASE2_EXPONENT = require( './../../../float64/max-base2-exponent' );
import MAX_BASE2_EXPONENT_SUBNORMAL = require( './../../../float64/max-base2-exponent-subnormal' );
import MAX_BASE10_EXPONENT = require( './../../../float64/max-base10-exponent' );
import MAX_BASE10_EXPONENT_SUBNORMAL = require( './../../../float64/max-base10-exponent-subnormal' );
import MAX_LN = require( './../../../float64/max-ln' );
import MAX_NTH_DOUBLE_FACTORIAL = require( './../../../float64/max-nth-double-factorial' );
import MAX_NTH_FACTORIAL = require( './../../../float64/max-nth-factorial' );
import MAX_SAFE_FIBONACCI = require( './../../../float64/max-safe-fibonacci' );
import MAX_SAFE_INTEGER = require( './../../../float64/max-safe-integer' );
import MAX_SAFE_LUCAS = require( './../../../float64/max-safe-lucas' );
import MAX_SAFE_NTH_DOUBLE_FACTORIAL = require( './../../../float64/max-safe-nth-double-factorial' );
import MAX_SAFE_NTH_FACTORIAL = require( './../../../float64/max-safe-nth-factorial' );
import MAX_SAFE_NTH_FIBONACCI = require( './../../../float64/max-safe-nth-fibonacci' );
import MAX_SAFE_NTH_LUCAS = require( './../../../float64/max-safe-nth-lucas' );
import MAX_SAFE_NTH_TRIBONACCI = require( './../../../float64/max-safe-nth-tribonacci' );
import MIN_BASE2_EXPONENT = require( './../../../float64/min-base2-exponent' );
import MIN_BASE2_EXPONENT_SUBNORMAL = require( './../../../float64/min-base2-exponent-subnormal' );
import MIN_BASE10_EXPONENT = require( './../../../float64/min-base10-exponent' );
...
import NUM_HIGH_WORD_SIGNIFICAND_BITS = require( './../../../float64/num-high-word-significand-bits' );
import PHI = require( './../../../float64/phi' );
import PI = require( './../../../float64/pi' );
import PI_SQUARED = require( './../../../float64/pi-squared' );
import PINF = require( './../../../float64/pinf' );
import PRECISION = require( './../../../float64/precision' );
import SMALLEST_NORMAL = require( './../../../float64/smallest-normal' );
import SMALLEST_SUBNORMAL = require( './../../../float64/smallest-subnormal' );
import SQRT_EPS = require( './../../../float64/sqrt-eps' );
import SQRT_HALF = require( './../../../float64/sqrt-half' );
import SQRT_HALF_PI = require( './../../../float64/sqrt-half-pi' );
import SQRT_PHI = require( './../../../float64/sqrt-phi' );
import SQRT_PI = require( './../../../float64/sqrt-pi' );
import SQRT_THREE = require( './../../../float64/sqrt-three' );
import SQRT_TWO = require( './../../../float64/sqrt-two' );
import SQRT_TWO_PI = require( './../../../float64/sqrt-two-pi' );
import TWO_PI = require( './../../../float64/two-pi' );
...
interface Namespace {
	...
	*
	* @example
	* var bits = ns.NUM_HIGH_WORD_SIGNIFICAND_BITS;
	* // returns 20
	*/
	NUM_HIGH_WORD_SIGNIFICAND_BITS: typeof NUM_HIGH_WORD_SIGNIFICAND_BITS;
